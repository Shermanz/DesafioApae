...
DataTable.prototype = {
    ...
    setRefreshTimeout: function () {
        if (this.options.data.refresh) {
            ...
            this.refreshTimeOut = setTimeout(function (datatable) {
                return function () {
                    datatable.getAjaxDataAsync(0, true);
                };
            ...
            childs.forEach(function (e) {
                ...
                if (e.childNodes.length > 0) {
                    e.childNodes[0].addEventListener('click', function (event) {
                        ...
                        if (this.parentNode.classList.contains('active') || typeof this.dataset.page === 'undefined') {
                            return;
                        }
    ...
    createSelectFilter: function (field) {
        ...
        var values = {},
            ...
            multiple = false,
            empty = true,
            emptyValue = this.options.filterEmptySelect;
        var tag = false;
    ...
    destroySort: function () {
        $('thead th').removeClass('sorting sorting-asc sorting-desc').unbind('click.datatable').removeData('sort');
    },
